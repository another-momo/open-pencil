...
> **身份**：本档案只持有针对 02-phase-0.md 的腐烂/修正/核验记录。**完整 [02-phase-0.md §0](02-phase-0.md) 执行期修正明细（8 条）保留在 `records/docs-governance.md` 修正-2**——本档案只留指针，避免双向源污染。

---

## 腐烂类（派生自 records/docs-governance.md ROT-5~14）

## ROT-5 · 02 v1 locale 删 8 收 zh-cn+en

- **派生自**：`records/docs-governance.md` ROT-5
...
- **派生自**：`records/docs-governance.md` ROT-6
...
- **派生自**：`records/docs-governance.md` ROT-7
...
- **派生自**：`records/docs-governance.md` ROT-8
...
- **派生自**：`records/docs-governance.md` ROT-12
- **错误**：tauri 需 stub 壳
- **实况**：Agent A 实测：静态 import 遍布 ~20 文件，保持纯净 + 保留依赖即可
- **处置**：02 已修正（详见 `records/docs-governance.md` 修正-2 第 1 条）

## ROT-13 · 02 v2 .lfsconfig 改指自有 LFS + CI 补 7 处 lfs

- **派生自**：`records/docs-governance.md` ROT-13
- **错误**：`.lfsconfig` 改指自有 LFS + CI 补 7 处 lfs
- **实况**：自有 LFS 超额、上游网关匿名可读、剩余 workflow 不需要补
- **处置**：02 已修正，P21 撤销（详见 `records/docs-governance.md` 修正-2 第 2 条）

## ROT-14 · 02 v2 i18n 缝落位 src/app/i18n/ 根

- **派生自**：`records/docs-governance.md` ROT-14
- **错误**：i18n 缝落位 src/app/i18n/ 根
- **实况**：上游 #557 已占用该目录（notifications/），缝避让至 fork/ 子目录
- **处置**：02 已修正（详见 `records/docs-governance.md` 修正-2 第 4 条）
...
- **派生自**：`records/docs-governance.md` 修正-2
- **原文位置**：[02-phase-0.md](../../02-phase-0.md) 旧版 §0「执行期修正」（8 条，已删除）
- **迁移去向**：`records/docs-governance.md`「02-phase-0.md 执行期修正明细」章节
...
- **派生自**：`records/ci-infra.md` P0-1~P0-10
- **结论**：Phase 0 gate review 通过——详细见 `records/ci-infra.md`

## P0-8 · Phase 0 gate review 机械审计

- **派生自**：`records/docs-governance.md` P0-8
