...
| [T24](../tasks/T24-plan.md) | Phase 1-pi 实施            | prompt 装配（三段式 + extension 注入 + chatMode 请求级 + brand 种子薄切）            | 🔄 立项（2026-08-24 recon 完成，待 owner 评审） | [T24-plan](../tasks/T24-plan.md) | [T24-self-check](../tasks/T24-self-check.md) | [T24-verify](../tasks/T24-verify.md) |
| (后续 task 按顺序登记)      | —                          | —                                                                                                      | —                                                                                                                                            | —                                | —                                            | —                                    |
