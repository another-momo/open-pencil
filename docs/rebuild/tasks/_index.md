...
| [T07](../tasks/T07-plan.md) | 文档治理 | 修正 §4.10 应用错误（横向档案 narrative 绑定撤回）+ 高频腐烂防御 | 🔄 进行中 | [T07-plan](../tasks/T07-plan.md) | [T07-self-check](../tasks/T07-self-check.md) | [T07-verify](../tasks/T07-verify.md) |
| [T08](../tasks/T08-plan.md) | 文档治理 | tracker.md 任务表删 PR 列（owner 提议） | 🔄 进行中 | [T08-plan](../tasks/T08-plan.md) | [T08-self-check](../tasks/T08-self-check.md) | [T08-verify](../tasks/T08-verify.md) |
| (后续 task 按顺序登记) | — | — | — | — | — | — |
