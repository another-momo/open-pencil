...
| [T48](../tasks/T48-plan.md) | Phase 3 · watercolor_poster_v2 抢救性迁移 + T44 保真核验脚本修复 | v2 自 git 钉扎源补迁（节名归一/applicable_to→[longform]/真 Recipe 逐字）+ verify-t44 失效源修复（git 钉扎） | 🔄 进行中 | [T48-plan](../tasks/T48-plan.md) | [T48-self-check](../tasks/T48-self-check.md) | [T48-verify](../tasks/T48-verify.md) |
| (后续 task 按顺序登记)      | —                          | —                                                                                                                       | —                                                                                                                                            | —                                | —                                            | —                                    |
