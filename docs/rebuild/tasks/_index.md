...
| [T23](../tasks/T23-plan.md) | Phase 1-pi 实施            | 会话查看/切换 UI（族谱清单 + ChatPanel 会话栏下拉）                                  | 🔄 立项（owner 直接诉求 2026-08-24） | [T23-plan](../tasks/T23-plan.md) | [T23-self-check](../tasks/T23-self-check.md) | [T23-verify](../tasks/T23-verify.md) |
| (后续 task 按顺序登记)      | —                          | —                                                                                                      | —                                                                                                                                            | —                                | —                                            | —                                    |
