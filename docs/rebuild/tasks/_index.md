...
| [T50](../tasks/T50-plan.md) | CI 红修复收口（run 33372323229 + run 33382389558） | 两轮七处：T47 路径后遗症 / tools stub / GHOST dd15190f 采纳 / sherif 排序 / check:tasks 逐 push 口径补立 / jscpd 克隆消除 / clipboard 守卫 | ✅ 已完成（2026-08-31 收口） | [T50-plan](../tasks/T50-plan.md) | [T50-self-check](../tasks/T50-self-check.md) | [T50-verify](../tasks/T50-verify.md) |
| [T51](../tasks/T51-plan.md) | CI 第三轮修复（GHOST silhouette + steiger 合规化） | silhouette 跟随上游删除 + 十二文件迁 domain 子目录（probes/studio/verify/build）+ FontsSettingsPanel title 换 Tip + 34 文件引用扫零 + base.md 链重新生成 | ✅ 已完成（2026-08-31 收口） | [T51-plan](../tasks/T51-plan.md) | [T51-self-check](../tasks/T51-self-check.md) | [T51-verify](../tasks/T51-verify.md) |
| [T52](../tasks/T52-plan.md) | Phase 3 · W2/T-B1 brief 四区改造 + 三件套移植 + 放置统一策略 | fork/marketing 新建 + 四区（关联设计区含 mode/type 投影）+ zone 标记寻址 + schemaVersion + 歧义防护补齐 + tombstone 保痕 + 共享 findPlacementPosition | ✅ 已完成（2026-09-01 收口） | [T52-plan](../tasks/T52-plan.md) | [T52-self-check](../tasks/T52-self-check.md) | [T52-verify](../tasks/T52-verify.md) |
| [T53](../tasks/T53-plan.md) | Phase 3 · W2/T-B2 setup_design 窄化 + 无状态三态解析 | 四职责 + 注入缝校验 + registry 删除换无状态扫描 + 结构化信封九 code + 恒新建 | ✅ 已完成（2026-09-01 收口） | [T53-plan](../tasks/T53-plan.md) | [T53-self-check](../tasks/T53-self-check.md) | [T53-verify](../tasks/T53-verify.md) |
| [T54](../tasks/T54-plan.md) | Phase 3 · W2/T-B3 generate_image 管线移植 + 凭证链新建 | 管线四分 + 双段执行拓扑 + DMX provider 核心（路线乙）+ 凭证三键进程级注入 + 设置 UI 预设收敛 + OPENPENCIL_RPC_TIMEOUT_MS + 并发竞态修复 + 凭证 mock 进 CI | ✅ 已完成（2026-09-01 收口） | [T54-plan](../tasks/T54-plan.md) | [T54-self-check](../tasks/T54-self-check.md) | [T54-verify](../tasks/T54-verify.md) |
| [T55](../tasks/T55-plan.md) | Phase 3 · W2/T-B4 look 移植（通道 A + 媒体元数据字段化） | 三档导出 + 缩放策略 + 通道 A base64（媒体登记 pi-backend 侧）+ renderInContext/clip 主机能力前置 | ✅ 已完成（2026-09-01 收口） | [T55-plan](../tasks/T55-plan.md) | [T55-self-check](../tasks/T55-self-check.md) | [T55-verify](../tasks/T55-verify.md) |
| [T56](../tasks/T56-plan.md) | Phase 3 · W2/T-B5 ask_user_question 新建 | 双件布局 + run 终止续跑 + 聊天内表单卡片 + 答案信封 + Case B 复用锚 | ✅ 已完成（2026-09-01 收口） | [T56-plan](../tasks/T56-plan.md) | [T56-self-check](../tasks/T56-self-check.md) | [T56-verify](../tasks/T56-verify.md) |
| [T57](../tasks/T57-plan.md) | Phase 3 · W2/T-B6 prepare_hero_scaffold 移植 | 标题前置克隆源 + 页面级放置 + 几何记录写入/钳制 + note 三分解体 | ✅ 已完成（2026-09-01 收口） | [T57-plan](../tasks/T57-plan.md) | [T57-self-check](../tasks/T57-self-check.md) | [T57-verify](../tasks/T57-verify.md) |
...
| [T58](../tasks/T58-plan.md) | Phase 3 · W3/T-B7 compose_backdrop 移植 | 几何只读记录 + 隐式收养删除换 discard_hero + 采样注入 seam | ✅ 已完成（2026-09-01 收口） | [T58-plan](../tasks/T58-plan.md) | [T58-self-check](../tasks/T58-self-check.md) | [T58-verify](../tasks/T58-verify.md) |
| [T60](../tasks/T60-plan.md) | Phase 3 · W3/T-B9 宿主路由与每回合组装 | active_design 单槽 + 四事件移槽 + 每回合组装 + 新建意图旗标 + chatMode 退役 | ✅ 已完成（2026-09-01 收口） | [T60-plan](../tasks/T60-plan.md) | [T60-self-check](../tasks/T60-self-check.md) | [T60-verify](../tasks/T60-verify.md) |
| [T61](../tasks/T61-plan.md) | Phase 3 · W3/T-B10 选择器 UI 重做 | chips 回显 + 新建意图确认卡 + 设计列表/需求单面板 + 同意卡 + T24 链退役 | ✅ 已完成（2026-09-01 收口） | [T61-plan](../tasks/T61-plan.md) | [T61-self-check](../tasks/T61-self-check.md) | [T61-verify](../tasks/T61-verify.md) |
