...
| [T46](../tasks/T46-plan.md) | Phase 3 · base.md v0 落位 + 红线补洞 + base 候选清单建档（S4 W1 / T-A5） | 576 行 UI prompt 转写 studio/base.md（组装不动，W2/W3 接入）+ 四红线齐全性检查与修辞事实标注段（PD-20 ①）+ base 候选清单建档（PD-20 ②）+ 免 label schema 成文 + 钉扎 failures 收零 | 🔄 进行中（2026-08-31 立项） | [T46-plan](../tasks/T46-plan.md) | [T46-self-check](../tasks/T46-self-check.md) | [T46-verify](../tasks/T46-verify.md) |
| (后续 task 按顺序登记)      | —                          | —                                                                                                                       | —                                                                                                                                            | —                                | —                                            | —                                    |
