...
| [T17](../tasks/T17-plan.md) | Phase 1-X 实施 | ChatPanel 消费 SessionFace（M3 消息回路半） | 🔄 开工（注册期 recon 完成） | [T17-plan](../tasks/T17-plan.md) | [T17-self-check](../tasks/T17-self-check.md) | [T17-verify](../tasks/T17-verify.md) |
| (后续 task 按顺序登记) | — | — | — | — | — | — |
