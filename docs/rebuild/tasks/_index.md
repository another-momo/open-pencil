...
|---|---|---|---|---|---|---|
| [T00](T00-docset-v1-2026-08-18.md) | 文档治理 | 文档集首轮整改（R1-R4 核查轮）| ✅ 已完成（历史回填）| ✅ | T00 | 100% |
...
| [T02](T02-doc-discipline-check-2026-08-20.md) | 文档治理 | 文档纪律二次检查（05 §5 迁移 + check-tasks 增强） | ✅ 已完成（CI 11/11 全绿） | ✅ | T02 | 92%（核验-N 后置） |
| [T03](T03-process-binding-clause-2026-08-21.md) | 文档治理 | 05 §4.10 文件↔record 一一对应纪律补漏（D14 决策落地） | 🔄 进行中 | ✅ | T03 | 待自检 |
| (后续 task 按顺序登记) | — | — | — | — | — | — |
