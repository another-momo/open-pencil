...
| [T31](../tasks/T31-plan.md) | upstream 合并第二轮 | upstream/master@88c10770 合并（vector/clipboard/tool-state/recovery 四 commit 快进 + 四 commit 维持删除 + i18n pi* key 合并回写） | 🔄 进行中 | [T31-plan](../tasks/T31-plan.md) | [T31-self-check](../tasks/T31-self-check.md) | [T31-verify](../tasks/T31-verify.md) |
| (后续 task 按顺序登记)      | —                          | —                                                                                                                       | —                                                                                                                                            | —                                | —                                            | —                                    |
