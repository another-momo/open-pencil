...
| [T16](../tasks/T16-plan.md) | Phase 1-X 实施 | 7600 桥真链路 + token 链（M3+M4 链路半） | 🔄 开工（B1 桥 server 形态探针先行；协议/鉴权已源码实证） | [T16-plan](../tasks/T16-plan.md) | [T16-self-check](../tasks/T16-self-check.md) | [T16-verify](../tasks/T16-verify.md) |
| (后续 task 按顺序登记) | — | — | — | — | — | — |
