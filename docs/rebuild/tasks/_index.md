...
| [T49](../tasks/T49-plan.md) | Phase 3 · base 红线补洞段及机制撤除 + S1-product-spec.md §7 层归属修正 | base.md 纯转写化 + 补洞机制拆除 + S1-product-spec.md §7 删三行/五改宿主 + S4-phase3-plan.md 同步 | 🔄 进行中 | [T49-plan](../tasks/T49-plan.md) | [T49-self-check](../tasks/T49-self-check.md) | [T49-verify](../tasks/T49-verify.md) |
| (后续 task 按顺序登记)      | —                          | —                                                                                                                       | —                                                                                                                                            | —                                | —                                            | —                                    |
