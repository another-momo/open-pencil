...
| [T43](../tasks/T43-plan.md) | Phase 3 · studio 资产文件机制内核（S4 W1 / T-A1，分支 rebuild/mode-arch） | 三类资产统一文件机制：两源扫描+同 id 覆盖 + frontmatter 解析 + 按类加载期校验 + 失败显式暴露数据面 + general 特例 + reload API | 🚧 进行中（2026-08-30 立项） | [T43-plan](../tasks/T43-plan.md) | [T43-self-check](../tasks/T43-self-check.md) | [T43-verify](../tasks/T43-verify.md) |
| (后续 task 按顺序登记)      | —                          | —                                                                                                                       | —                                                                                                                                            | —                                | —                                            | —                                    |
