...
| [T06](../tasks/T06-plan.md) | CI 基础设施 | LFS cache 启用（每次 push 节省 ~99% 上游 LFS 流量） | 🔄 进行中 | [T06-plan](../tasks/T06-plan.md) | [T06-self-check](../tasks/T06-self-check.md) | [T06-verify](../tasks/T06-verify.md) |
| (后续 task 按顺序登记) | — | — | — | — | — | — |
