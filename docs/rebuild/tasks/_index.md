...
| [T12](../tasks/T12-plan.md) | Phase 1 runtime | S-X spike（dsh-X 六项验证含硬 gate） | 🔄 离线面六项全绿 + subagent 核验「可以提交」（待 push 后 CI） | [T12-plan](../tasks/T12-plan.md) | [T12-self-check](../tasks/T12-self-check.md) | [T12-verify](../tasks/T12-verify.md) |
| (后续 task 按顺序登记) | — | — | — | — | — | — |
