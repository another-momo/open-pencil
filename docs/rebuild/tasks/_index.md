...
| [T45](../tasks/T45-plan.md) | Phase 3 · manifest 投影改源 + brand 链退役（S4 W1 / T-A3） | 端点更名 /api/pi/studio/manifest（modes 展开 + profiles 摘要 + failures 路径脱敏）+ service 改源 getStudioRegistry + overlay 适配 + 前端两件更名 + brand/ 目录删除退休 | 🔄 进行中（2026-08-31 立项） | [T45-plan](../tasks/T45-plan.md) | [T45-self-check](../tasks/T45-self-check.md) | [T45-verify](../tasks/T45-verify.md) |
| (后续 task 按顺序登记)      | —                          | —                                                                                                                       | —                                                                                                                                            | —                                | —                                            | —                                    |
