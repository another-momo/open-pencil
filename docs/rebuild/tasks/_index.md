...
| [T22](../tasks/T22-plan.md) | Phase 1-pi 实施            | session↔file 绑定（docUuid 身份 + 会话族谱 + 历史回填 + 工具目标注入）               | 🔄 方案定稿 | [T22-plan](../tasks/T22-plan.md) | [T22-self-check](../tasks/T22-self-check.md) | [T22-verify](../tasks/T22-verify.md) |
| (后续 task 按顺序登记)      | —                          | —                                                                                                      | —                                                                                                                                            | —                                | —                                            | —                                    |
