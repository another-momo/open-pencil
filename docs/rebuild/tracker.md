...
| T12 | Phase 1 runtime | S-X spike（dsh-X 六项验证含硬 gate，[spikes/04-dsh-x-design.zh.md §7.1](spikes/04-dsh-x-design.zh.md)） | [T12-plan.md §3](tasks/T12-plan.md) | 🔄 离线面六项全绿 + subagent 核验「可以提交」（待 push 后 CI） | [T12-plan](tasks/T12-plan.md) | [T12-self-check](tasks/T12-self-check.md) | [T12-verify](tasks/T12-verify.md) |
| — | （后续 task 按顺序登记） | — | — | — | — | — | — |
