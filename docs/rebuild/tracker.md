...
| T05 | 文档治理 | 00-05 系统性腐烂 review（外部 proposal 内化 + 05 §2 树状图重写 + D16 候选登记）| 🔄 进行中 | — | [T05-plan](tasks/T05-plan.md) | [T05-self-check](tasks/T05-self-check.md) | [T05-verify](tasks/T05-verify.md) |
| — | （Phase 1 开工后逐行登记） | — | — | — | — | — | — | — |
