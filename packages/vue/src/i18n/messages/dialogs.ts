...
export const dialogMessageDefaults = {
  ...
  briefPanelTitle: 'Design brief',
  briefPanelDescription: 'Edit the brief as a form — changes write back to the canvas immediately.',
  briefPanelContentLabel: 'Brief content',
  briefPanelContentPlaceholder: 'Brand · campaign · price · timing · copy direction',
  briefPanelMaterialsLabel: 'Materials',
  briefPanelCaptionPlaceholder: 'Note the purpose (key visual / card image / style reference)',
  briefPanelAddMaterial: 'Add material',
  briefPanelAddFromSelection: 'Add from canvas selection',
  briefPanelAddSelectionMove: 'Move into brief (recommended) — original removed from canvas',
  briefPanelAddSelectionCopy: 'Copy into brief — original stays on canvas',
  briefPanelRemoveMaterial: 'Remove material',
  briefPanelAiLabel: 'AI conclusions',
  briefPanelAiEmpty: '(No conclusions yet)',
  briefPanelAiNote: 'Conclusions confirmed by the AI, appended across sessions.',
  briefPanelEmpty: 'This document has no design brief yet.',
  briefPanelCreate: 'New design brief',
  briefPanelBroken: 'The brief structure is broken. Check or recreate it on the canvas.',
  briefPanelApplyFailed: 'Could not apply the change — it was rolled back.',
  materialLibrary: 'Material library',
  materialLibraryDescription:
    'The default library ships with the app. Upload your own .fig to replace it.',
  uploadLibrary: 'Upload .fig',
  libraryWarningsSection: 'Library parse warnings',
  documentMadeWithLibrary: 'This document has designs made with library',
  resubmitLibraryHint: 'Re-submit that library file to continue those designs.',
  injectSelected: 'Inject selected',
  libraryLoadFailed: 'Failed to load the default library',
  retry: 'Retry',
  chipType: 'Type',
  chipProfile: 'Style',
  ...
  profileGalleryEmpty: 'No profiles match the search',
  apiKey: 'API Key',
  apiType: 'API Type',
  baseURL: 'Base URL',
  modelID: 'Model ID',
  ...
  imageGenAPIKey: 'Image Generation API Key',
  imageGenBaseURL: 'Image Generation Base URL',
  imageGenModel: 'Image Generation Model',
  imageGenAPIKeyPlaceholder: 'Separate from the chat LLM key — for generate_image tool',
  imageGenAPIDocs: 'Image API docs →',
  visionSection: 'Vision (look)',
  visionModeA: 'A — main model sees images',
  visionModeB: 'B — independent vision model',
  visionProvider: 'Vision provider type',
  visionProviderOpenAI: 'OpenAI-compatible (/chat/completions)',
  visionProviderAnthropic: 'Anthropic-compatible (/messages)',
  visionAPIKey: 'Vision API Key',
  visionBaseURL: 'Vision Base URL',
  visionModel: 'Vision Model',
  visionAPIKeyPlaceholder: 'Independent vision credentials — used by look in channel B',
