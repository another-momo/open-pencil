      ...
      >
        ...
        <div class="mt-3 flex items-center gap-2">
          <input
            ...
            class="flex-1 rounded border border-border bg-surface px-2 py-1 text-xs text-surface placeholder:text-muted focus:border-accent focus:outline-none"
          />
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              class="absolute right-1 top-1 rounded p-0.5 text-muted hover:bg-surface/10 hover:text-surface"
        ...
        >
          <div class="w-[560px] max-w-[90vw] rounded-lg bg-surface p-4 shadow-2xl">
            <div class="mb-2 flex items-center justify-between">
              ...
              <button
                type="button"
                class="rounded p-1 text-muted hover:bg-surface/10 hover:text-surface"
            ...
            <pre
              class="max-h-[60vh] overflow-y-auto whitespace-pre-wrap rounded border border-border bg-surface p-3 text-[11px] leading-relaxed text-surface"
